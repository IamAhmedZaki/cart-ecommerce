    ...
    <>
      ...
      >
            ...
            cartItems.map((item) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="font-bold text-[#f9c821]">
                    ${item.price}
                  </p>
        ...
        <div className="absolute bottom-0 left-0 w-full p-5 border-t bg-white">
          ...
          <button className="w-full py-3 bg-[#f9c821] hover:bg-yellow-500 text-white font-bold rounded-lg" >
           <Link to="/checkout" className="w-full py-3 bg-[#f9c821] hover:bg-yellow-500 text-white font-bold rounded-lg" onClick={onClose} >
            Checkout
          </Link>
          </button>
        </div>

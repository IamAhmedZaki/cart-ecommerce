...
const { brandName, modelId } = useParams();
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-12 mt-20">
      ...
      <div className="bg-[#f9c821] border-b border-gray-200 sticky top-40 z-10 hidden md:block ">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          {/* Sidebar – Brands */}
          <aside className="hidden lg:block w-full lg:w-72 bg-white border border-gray-200 rounded-xl p-5 shadow-sm sticky top-55 self-start">
                ...
                {products.map((product) => (
                  ...
                  >
                    ...
                    <div className="relative w-full aspect-square bg-gray-100 overflow-hidden">
                      <img
                        src={`https://ecou1bc3kziqxgke.public.blob.vercel-storage.com/products/${
                    ...
                    <div className="p-3 sm:p-4">
                      ...
                      <div className="flex items-baseline gap-2">
                        <span className="text-lg sm:text-xl font-bold text-amber-700">
                          $ {Math.round(product.salePrice).toLocaleString()}
                        </span>
